...
- Generated at: `2026-04-12T13:42:24.457862+00:00`
- Repo root: `/home/nikoles16/Documents/ScreenWire Environments/screenwire-pipeline`
- Python modules indexed: `50`
- Internal dependency edges: `131`
- External packages referenced: `56`
...
- `tests.test_alignment_contracts` -> `18` internal imports
...
- `handlers.base` -> `3` internal imports
...
- `handlers.reference_pack` <- `3` internal dependents
...
- `pathlib` referenced `42` time(s)
- `__future__` referenced `39` time(s)
- `json` referenced `26` time(s)
- `typing` referenced `23` time(s)
- `os` referenced `18` time(s)
- `re` referenced `18` time(s)
